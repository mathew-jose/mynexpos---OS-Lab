...
load --int=console $HOME/myexpos/spl/spl_progs/console_stage16.xsm
...
load --init $HOME/myexpos/expl/samples/init_stage16.xsm
load --idle $HOME/myexpos/expl/samples/idle_stage12.xsm
load --module 0 $HOME/myexpos/spl/spl_progs/module0_stage16.xsm
load --module 4 $HOME/myexpos/spl/spl_progs/module4_stage16.xsm
load --module 7 $HOME/myexpos/spl/spl_progs/boot_module_stage16.xsm
