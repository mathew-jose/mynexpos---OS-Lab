...
load --exec $HOME/myexpos/expl/samples/odd_20.xsm
load --exec $HOME/myexpos/expl/samples/even_20.xsm
load --int=console $HOME/myexpos/spl/spl_progs/console_17.xsm
load --int=disk $HOME/myexpos/spl/spl_progs/disk_interrupt_stage18.xsm
...
load --int=8 $HOME/myexpos/spl/spl_progs/int8_stage20.xsm
...
load --module 7 $HOME/myexpos/spl/spl_progs/boot_module_stage21.xsm
load --module 5 $HOME/myexpos/spl/spl_progs/module5_stage20.xsm
load --module 2 $HOME/myexpos/spl/spl_progs/module2_stage19.xsm
load --module 1 $HOME/myexpos/spl/spl_progs/module1_stage21.xsm
