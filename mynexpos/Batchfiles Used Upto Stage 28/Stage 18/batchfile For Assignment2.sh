...
load --exec $HOME/myexpos/expl/samples/odd_17.xsm
...
load --module 7 $HOME/myexpos/spl/spl_progs/boot_module_stage18.xsm
load --module 5 $HOME/myexpos/spl/spl_progs/module5_stage16.xsm
load --module 2 $HOME/myexpos/spl/spl_progs/module2_stage18.xsm
load --module 1 $HOME/myexpos/spl/spl_progs/module1_stage17.xsm
load --int=9 $HOME/myexpos/spl/spl_progs/int9_stage18.xsm
